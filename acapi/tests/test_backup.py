...
class TestBackup(BaseTest):
    ...
    def setUp(self):
        ...
        self.backup = (
            self.client.site("mysite").environment("dev").db("mysite").backup(22)
        )
    ...
    def test_delete(self, mocker):
        ...
        mocker.register_uri(
            "DELETE", url, json=self.generate_task_dictionary(1117, "waiting", False)
        )
        mocker.register_uri(
            "GET",
    ...
    def test_download_stream(self, mocker):
        ...
        mocker.register_uri("GET", url, json=backup)
